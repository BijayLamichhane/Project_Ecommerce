...
export function BookingsPage() {
  ...
  const getStatusBadge = (status: string) => {
    const styles: Record<string, string> = { confirmed: "bg-[#F1ECE1] text-[#C17817]", active: "bg-[#E7EFE2] text-[#4B5D3A]", return_requested: "bg-[#F1ECE1] text-[#C17817]", returned: "bg-[#E8E1D5] text-[#514B44]", completed: "bg-[#E8E1D5] text-[#514B44]", pending: "bg-[#F1ECE1] text-[#C17817]", cancelled: "bg-[#FBE9E5] text-[#A23B2E]", rejected: "bg-[#FBE9E5] text-[#A23B2E]" };
